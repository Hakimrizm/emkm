      ...
      <div>
        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <li>
            <a
              href="#"
              @click.prevent="selected = (selected === 'pengeluaran' ? '':'pengeluaran')"
              class="menu-item group"
              :class=" (selected === 'pengeluaran') ? 'menu-item-active' : 'menu-item-inactive'"
            >
              <svg
                :class="(selected === 'pengeluaran') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
              ...
              <svg
                class="menu-item-arrow"
                :class="[(selected === 'pengeluaran') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]"
                width="20"
                height="20"
                viewBox="0 0 20 20"
                fill="none"
            ...
            <div
              class="overflow-hidden transform translate"
              :class="(selected === 'pengeluaran') ? 'block' :'hidden'">
              <ul
                :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                <li>
          ...
          <li>
            ...
            >
              <svg
                :class="(selected === 'laporan_keuangan') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
          ...
          <li>
            ...
            >
              <svg
                :class="(selected === 'hitung-hpp') && (page === 'hitung-hpp') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
      ...
      <div>
        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <li>
            ...
            >
              <svg
                :class="(selected === 'Profile-Company') && (page === 'Profile-Company') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
